...
Uygulamayı IDE kullanmadan hazır hale getirmenin bir başka yöntemi ise proje içerisinde bulunan JAR dosyasını bilgisayarınıza indirerek Komut İstemi'nden uygulamayı çalıştırmaktır (<a href="https://github.com/frtyildiz/VeterinaryClinicManagementSystem/blob/main/VetClinicManagementSystem/target/VetClinicManagementSystem-0.0.1-SNAPSHOT.jar">Projenin JAR dosyasını indirmek tıklayınız</a>). Bunun için, Komut İstemi'ni çalıştırdıktan sonra projenin JAR dosyasının bilgisayarınızda bulunduğu konuma gitmeniz gerekmektedir (<a href="https://raw.githubusercontent.com/frtyildiz/VeterinaryClinicManagementSystem/main/images/Console1.png">Görüntülemek için tıklayınız</a>). JAR dosyasının bulunduğu konum üzerinden Komut İstemci'sine "java -jar VetClinicManagementSystem-0.0.1-SNAPSHOT.jar" komutunu yazarak Enter tuşuna bastığınız durumda proje çalıştırılacaktır (<a href="https://raw.githubusercontent.com/frtyildiz/VeterinaryClinicManagementSystem/main/images/Console2.png">Görüntülemek için tıklayınız</a>). Bu sayede internet tarayıcınızın adres çubuğuna http://localhost:8080/ yazarak, uygulamaya erişebilir ve ilgili işlemleri gerçekleştirebilirsiniz (<a href="https://raw.githubusercontent.com/frtyildiz/VeterinaryClinicManagementSystem/main/images/Home.png">Görüntülemek için tıklayınız</a>).
